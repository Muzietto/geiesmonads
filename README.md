...
Test page is [here](https://muzietto.github.io/geiesmonads/parsers/Mocha_Parser_Combinators_Tests_RAWGIT.html).

Live examples page is [here](https://muzietto.github.io/geiesmonads/parsers/Console_Parser_Examples_RAWGIT.html).

A [JSON parser](https://muzietto.github.io/geiesmonads/parsers/js/json_parsers.js) is under construction, and it is tested [here](https://muzietto.github.io/geiesmonads/parsers/Mocha_JSON_Parser_Tests_RAWGIT.html).
...
Test page is [here](https://muzietto.github.io/geiesmonads/MochaGeiesmonadsES6_Reader_Test.htm).

NB - with a big credit due to [Don't Fear the Reader](https://passy.svbtle.com/dont-fear-the-reader).

New with RELEASE 2.1
--------------------
[`Maybe`, `Either a`, `State`](https://muzietto.github.io/geiesmonads/MochaGeiesmonadsES6_Test.htm), [`StateMaybe`](https://muzietto.github.io/geiesmonads/MochaGeiesmonadsES6_StateMaybe_Test.htm) and [`StateEither`](https://muzietto.github.io/geiesmonads/MochaGeiesmonadsES6_StateEither_Test.htm) in ECMAScript 6.
...
See file [geiesmonads_0.2.js](https://github.com/Muzietto/geiesmonads/blob/master/js/geiesmonads_0.2.js) and [related tests](https://muzietto.github.io/geiesmonads/YUIGeiesmonads_Test.htm).
